        ...
        public void GenerateDocument(TempleteType TT, Student student, string qrCodePath, string amountOfCopies, DateTime Date)
        {
            ...
            switch (TT)
            {
                case TempleteType.Lined:
                    oTemplate = @"Templates\Lined Answer Sheet.dotx";
                    break;
                case TempleteType.Grid:
                    oTemplate = @"Templates\Grid Answer Sheet.dotx";
                    break;
                case TempleteType.TrueFalse:
                    oTemplate = @"Templates\True or False Answer Sheet.dotx";
                    break;
                case TempleteType.Monkey:
                    oTemplate = @"Templates\Monkey puzzle Answer Sheet.dotx";
                    break;
                case TempleteType.MatchAB:
                    oTemplate = @"Templates\Match A to B Answer Sheet.dotx";
                    break;
                case TempleteType.Crossword:
                    oTemplate = @"Templates\Crossword Answer Sheet.dotx";
                    break;
            }
